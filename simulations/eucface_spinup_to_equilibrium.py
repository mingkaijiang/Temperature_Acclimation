...
Spin-up assuming forest params, to check matches with EucFACE data.
...
USER = os.getlogin()
sys.path.append('/Users/%s/Documents/Research/Projects/Temperature_acclimation/Git/scripts' % (USER))
...
def main(experiment_id, site, SPIN_UP=True, POST_INDUST=True):
    ...
    if SPIN_UP == True:
        ...
        replace_dict = {
                        ...
                        "slamax": "5.1",    # 43.7 +/- 1.5 cm2 g 1 dry mass
                        "sla": "5.1",       # 43.7 +/-  1.5 cm2 g 1 dry mass
                        "slazero": "5.1",   # 43.7+/-  1.5 cm2 g 1 dry mass
